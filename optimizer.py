...
class opti:  
    ...
    def __init__(self,method):
        """
        Initialize of the opti class. Specifically, it initializes the history array and reads the method to assign to the scipy module.
    ...
    def minimizer_tool(self):
        ...
        -------
        res : dictionary
            Contains the result of the scipy optimization, including the solution (accessible at res.x) and the number of iterations (res.nit).
    ...
    def plot(self, res):
        ...
        ----------
        res : dictionary
            DContains the result of the scipy optimization, including the solution (accessible at res.x) and the number of iterations (res.nit).
